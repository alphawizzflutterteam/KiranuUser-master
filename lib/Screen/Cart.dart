...
double totalPrice = 0, oriPrice = 0, delCharge = 0, taxPer = 0, cartAmount = 0;
double subTotal = 0;
...
class StateCart extends State<Cart> with TickerProviderStateMixin {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                //       " " +
                //       cartList[index]
                //           .specialPriceWithoutTax .toString(),
                //   style: TextStyle(
                //       color: Theme.of(context).colorScheme.lightBlack2),
                // ),
                Text(
                  CUR_CURRENCY! +
                      " " +
                      cartList[index].special_price_without_tax.toString(),
                  style: TextStyle(
                      color: Theme.of(context).colorScheme.lightBlack2),
                ),
              ],
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "${cartList[index].productList![0].ispricesinclusivetax == '1' ? 'Inclusive' : 'Exclusive'}",
                  style: TextStyle(
                      color: Theme.of(context).colorScheme.lightBlack2),
                ),
              ],
            ...
            Row(
              ...
              children: [
                Text(
                  getTranslated(context, 'CONVENIENCE_CHARGE')!,
                  style: TextStyle(
                      color: Theme.of(context).colorScheme.lightBlack2),
                ),
                Text(
                  '${myList['data'][index]['charge_percentage'] ?? "0"}%',
                  style: TextStyle(
                      color: Theme.of(context).colorScheme.lightBlack2),
                ),
              ],
  ...
  String? tax_amount;
  String? convenience_charge_amount;
  String? sub_total;
  var myList;
  ...
  Future<void> _getCart(String save) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print('jhhhhhhhhhh:_____${parameter}______');
        ...
        if (!error) {
          ...
          delivery_charge = getdata['delivery_charge'];
          tax_amount = getdata['tax_amount'];
          convenience_charge_amount = getdata['convenience_charge_amount'];
          setState(() {
          ...
          print(myList['data'][0]['charge_percentage'] ?? "0.0");
          //   mainAxisAlignment: MainAxisAlignment.spaceBetween,

          print('kkkkkkkkk${getdata}');
          print("ssssssssssssssssssssssss$getdata['delivery_charge']");
          // oriPrice = double.parse(getdata['total_arr'].toString());
          oriPrice = double.parse(getdata['sub_total'].toString());
          subTotal = double.parse(getdata['sub_total'].toString());
          // cartAmount = double.parse(getdata['total_arr'].toString());
          cartAmount = double.parse(getdata['sub_total'].toString());
          print("aaaaaaaaaaaaaaaaaaaaa${cartAmount}");
    ...
    if (_isNetworkAvail) {
      try {
        ...
        if (!error) {
          ...
          cartAmount = double.parse(getdata['total_arr']);
          print("this aioa aaaaa${cartAmount}");
  ...
  //           .toStringAsFixed(2);
  //   print("amounttfaftt $totalamount");
  //   if (contact != '') {
  //     context.read<CartProvider>().setProgress(true);
  //     checkoutState!(() {});
  //     var options = {
  ...
  double getFinalAmount() {
    double total = double.parse(totalamount ?? '0.0');
    return total - promoAmt;
  }
  ...
  razorpayPayment() async {
    ...
    String amt = (finalAmount * 100).toStringAsFixed(0);
    print("Final Razorpay Amount: $finalAmount");
    print("Amount in Paise: $amt");
    if (contact != '') {
      context.read<CartProvider>().setProgress(true);
      checkoutState!(() {});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              //       CUR_CURRENCY! +
              //           " " +
              //           double.parse(tax_amount ?? "0.0").toStringAsFixed(2),
              //       style: TextStyle(
              //           color: Theme.of(context).colorScheme.fontColor,
              //           fontWeight: FontWeight.bold),
              //     )
              ...
              //       CUR_CURRENCY! +
              //           " " +
              //           double.parse(convenience_charge_amount ?? "0.0")
              //               .toStringAsFixed(2),
              //       style: TextStyle(
              //           color: Theme.of(context).colorScheme.fontColor,
              //           fontWeight: FontWeight.bold),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    CUR_CURRENCY! +
                        " " +
                        double.parse(delivery_charge ?? "0.0")
                            .toStringAsFixed(2),
                    style: TextStyle(
                        color: Theme.of(context).colorScheme.fontColor,
                        fontWeight: FontWeight.bold),
