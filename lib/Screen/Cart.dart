...
class StateCart extends State<Cart> with TickerProviderStateMixin {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        if (!error) {
          ...
          // "tax_percentage": "10",
          // "tax_amount": "222.2",
          // "convenience_charge_percentage": "7",
          // "convenience_charge_amount": "155.54",
          // "overall_amount": "2618.74",
          // "total_arr": 2241,
  ...
  razorpayPayment() async {
    print("subotal isss $totalamount hgghhhghghghgh $oriPrice");
    SettingProvider settingsProvider =
        Provider.of<SettingProvider>(this.context, listen: false);
    String? contact = settingsProvider.mobile;
    // String? email = settingsProvider.email;
    double res = double.parse(totalamount.toString());
    pricerazorpayy = int.parse(res.toStringAsFixed(0)) * 100;
    print("amountttt $pricerazorpayy");
    if (contact != '') {
      context.read<CartProvider>().setProgress(true);
      checkoutState!(() {});
      var options = {
