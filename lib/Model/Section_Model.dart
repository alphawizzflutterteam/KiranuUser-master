...
class SectionModel {
  ...
  SectionModel(
      ...
      this.special_price_without_tax,
      this.promoList});
  ...
  factory SectionModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return SectionModel(
        ...
        offset: 0,
        totalItem: 0,
        ispricesinclusivetax: parsedJson['is_prices_inclusive_tax'],
        specialPriceWithTax: parsedJson['special_price_with_tax'],
        special_price_without_tax: parsedJson['special_price_without_tax'],
        taxamountonprice: parsedJson['tax_amount_on_s_price'],
  ...
  factory SectionModel.fromCart(Map<String, dynamic> parsedJson) {
    ...
    return SectionModel(
      ...
      priceWithTax: parsedJson["price_with_tax"],
      priceWithoutTax: parsedJson["price_without_tax"],
      specialPriceWithTax: parsedJson["special_price_with_tax"],
      special_price_without_tax: parsedJson["special_price_without_tax"],
      taxamountonprice: parsedJson['tax_amount_on_s_price'],
      qty: parsedJson[QTY],
...
class Product_Varient {
  ...
  factory Product_Varient.fromJson(Map<String, dynamic> json) {
    ...
    return new Product_Varient(
        ...
        special_price_with_tax: json["special_price_with_tax"],
        price: json[PRICE],
        availability: json[AVAILABILITY].toString(),
